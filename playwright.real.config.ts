...
export default defineConfig({
  workers: 1,
  testDir: "./e2e",
  testMatch: /real(ApiWorkerJourney|InputSnapshot)\.spec\.ts/,
  timeout: 240_000,
  ...
  reporter: [
    ...
    [
      "html",
      {
        outputFolder: "outputs/test_evidence/playwright-real/html-report",
        open: "never",
      },
    ],
    [
      "json",
      { outputFile: "outputs/test_evidence/playwright-real/results.json" },
    ],
  ],
  use: {
